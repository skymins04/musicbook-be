...
export class Migration1680251163065 implements MigrationInterface {
    name = 'Migration1680251163065'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`widget-playlist\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`book\` CHANGE \`thumbnail_url\` \`thumbnail_url\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`book\` CHANGE \`background_img_url\` \`background_img_url\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`book\` CHANGE \`background_img_url\` \`background_img_url\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`book\` CHANGE \`thumbnail_url\` \`thumbnail_url\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`widget-playlist\` CHANGE \`deleted_at\` \`deleted_at\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`widget-playlist\` ADD CONSTRAINT \`FK_79ac7fa1108870afc1bc94cda2a\` FOREIGN KEY (\`book_id\`) REFERENCES \`book\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`widget-playlist\` ADD CONSTRAINT \`FK_96b0373b720e1a2e41d72e5324d\` FOREIGN KEY (\`user_id\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
