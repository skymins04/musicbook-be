...
export class Migration1678957499085 implements MigrationInterface {
    name = 'Migration1678957499085'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`preview_type\` \`preview_type\` enum ('YOUTUBE') NULL`);
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`mr_url\` \`mr_url\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`mr_type\` \`mr_type\` enum ('YOUTUBE') NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`mr_type\` \`mr_type\` enum ('YOUTUBE') NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`mr_url\` \`mr_url\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`music\` CHANGE \`preview_type\` \`preview_type\` enum ('YOUTUBE') NULL DEFAULT 'NULL'`);
