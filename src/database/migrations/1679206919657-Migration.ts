...
export class Migration1679206919657 implements MigrationInterface {
    name = 'Migration1679206919657'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`widget-playlist\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`theme_url\` varchar(255) NOT NULL DEFAULT 'https://cdn.musicbook.kr/basic_theme.css', \`font_size\` int NOT NULL DEFAULT '24', \`user_id\` varchar(36) NULL, \`book_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`widget-playlist\``);
    }
