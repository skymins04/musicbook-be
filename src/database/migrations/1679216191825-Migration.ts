...
export class Migration1679216191825 implements MigrationInterface {
    name = 'Migration1679216191825'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`widget-playlist\` CHANGE \`theme\` \`theme\` varchar(255) NOT NULL DEFAULT 'BASIC'`);
